...
No adaptation beats what the paper already does. Feature alignment is a real effect --- CORAL alone lifts QWK from $0.0132$ to $0.1742$, a factor of $13$ --- but it remains below rank calibration at $0.2266$, and stacking the two is worse than either ($0.1860$). Every row stays far below the $\approx 0.60$ clinical-agreement threshold, so the conclusion is unchanged; it is now supported rather than asserted.
